...
public class HelloWorldExercises {
    public static void main(String[] args){
        ...
        System.out.println("Edad: 39, Color: Negro, Ciudad: Getxo");
        // Explora los diferentes System.XXX.println(); más allá de "out".
        System.err.println("¡Ésto es un mensaje de error simulado!");
        // Utiliza varios println para imprimir una frase.
        System.out.print("Hola ");
        System.out.println("Mundo");
        // Carita negra redonda sonriente
        System.out.println("──▄▄▄▄▄▄▄\n" +
                "▄█▀▀▀█▀▀▀█▄\n" +
                "██▄█▄█▄█▄██\n" +
                "█████▄█████\n" +
